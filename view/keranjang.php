        ...
        <div class="offset-1 col-10">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Lihat Check Out || <b> Segera lakukan pembayaran </b> </h3>
              <div class="float-right">
                <form action="" method="post">
                  <label for="" style="margin-right: 20px">00:00:00</label>
                  <a href="?halaman=checkout&aksi=data" class="btn-sm btn-info"><i class="fas  fa-eye"></i> Lihat</a>
                <!-- <button type="button" name="" value="" class="btn-sm btn-info"><i class="fas  fa-eye"></i> Lihat</button> -->
              </div>
            </div>
